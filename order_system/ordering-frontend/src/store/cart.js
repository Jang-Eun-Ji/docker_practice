...
export default createStore({
    ...
    // action를 통해 여러 뮤테이션을 연속적으로 커밋하거나 , 비동기 작업을 진행, 
    // 일반적으로 component에서 actions의 메서드를 호출하고 actions에서 mutation메서드를 호출 
    actions:{
        // context매개변수가 주입. contet매개변수 안에 state, commit 등이 존재
